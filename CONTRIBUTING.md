...
Welcome to `kw-haw-pkg2` contributor's guide.
...
If you experience bugs or general issues with `kw-haw-pkg2`, please have a look
...
You can help improve `kw-haw-pkg2` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`kw-haw-pkg2` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `kw-haw-pkg2`'s files. While this mechanism can
...
```
conda create -n kw-haw-pkg2 python=3 six virtualenv pytest pytest-cov
conda activate kw-haw-pkg2
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/kw-haw-pkg2.git
   cd kw-haw-pkg2
   ```
...
5. Install [pre-commit]:
   ...
   `kw-haw-pkg2` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/kw-haw-pkg2
[issue tracker]: https://github.com/<USERNAME>/kw-haw-pkg2/issues
